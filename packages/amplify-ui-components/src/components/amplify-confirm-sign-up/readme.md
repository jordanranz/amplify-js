...
| `handleAuthStateChange` | --                   | Passed from the Authenticator component in order to change Authentication states e.g. SignIn -> 'Create Account' link -> SignUp                                                                                                                                                                                                                                                                                                                                                                                                                     | `(nextAuthState: AuthState, data?: object) => void` | `undefined`                          |
| `handleSubmit`          | --                   | Fires when sign up form is submitted                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `(submitEvent: Event) => void`                      | `() => this.confirmSignUp()`         |
| `headerText`            | `header-text`        | Used for header text in confirm sign up component                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `string`                                            | `CONFIRM_SIGN_UP_HEADER_TEXT`        |
